/*
 * This is a slightly modified version of the "testsprite" program
 * in the 'test' folder of SDL. See "COPYING.PUB" for terms of use.
 *
...
int main(int argc, char *argv[])
{
	...
	videoflags = SDL_SWSURFACE|SDL_ANYFORMAT|SDL_GLSDL|SDL_DOUBLEBUF;
	width = 640;
	height = 480;
	video_bpp = 8;
	while ( argc > 1 ) {
